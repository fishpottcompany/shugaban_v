                                ...
                                <div class="mx-1 mb-1">
                                    <div class="mb-6">
                                        ...
                                        <?php 
                                            ...
                                            $query2 = $queryController->prepareAndExecuteQuery($mysqli2, "SELECT name FROM " . CATEGORIES_FOR_MOVIES_TABLE . " LIMIT 16", 0, "", "");
                                            if($query2 === false){
                                                $messageModelObject->error_exist = false;
                                            ...
                                            // GETTING RESULTS
                                            $query_results_array2 = $queryController->getQueryResults($query2, array("name"), 1, 2);
                                            
                                            //BINDING THE RESULTS TO VARIABLES
                                            $query_results_array2->bind_result($name);
                                            ...
                                            <li class="mb-1">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                      ...
                                                      <label class="custom-control-label custom-control-label-custom" style="color: black;" for="action"><?php echo $name ?></label>
                                                    </div>
                                                </div>
                                            </li>
