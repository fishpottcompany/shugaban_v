            ...
            <div id="logoAndNav" class="container-fluid px-md-5">
                ...
                <nav class="js-mega-menu navbar navbar-expand-xl py-0 position-static justify-content-start">
                        ...
                        <div class="navbar-body header-abs-top-inner">
                            <ul class="navbar-nav">
                                <li class="hs-has-mega-menu navbar-nav-item">
                                    <a id="homeMegaMenu" class="hs-mega-menu-invoker nav-link font-secondary" href="index" aria-haspopup="false" aria-expanded="false"><b>Movies</b></a>
                                ...
                                <li class="hs-has-mega-menu navbar-nav-item">
                                    <a id="homeMegaMenu" class="hs-mega-menu-invoker nav-link font-secondary" href="free" aria-haspopup="false" aria-expanded="false"><b>Free</b></a>
                                    <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="homeMegaMenu">
                    ...
                    <div class="d-flex align-items-center ml-auto">
                        <form class="d-none d-xl-block"  id="search_form_main" action="search" method="GET" style="border-color: #495057;">
                            <label class="sr-only">Search</label>
                            <div class="input-group" style="border-color: #495057;">
                                <input  style="border-color: #495057;" name="s" type="text" class="search-form-control form-control py-2 pl-4 min-width-250 rounded-pill" name="search" id="searchproduct-item" aria-describedby="searchProduct1" required="">
                                ...
                                <li class="col d-xl-none position-static px-2">
                                    ...
                                    <div class="hs-unfold mr-2 position-static">
                                        ...
                                        <div id="searchClassic" class="hs-unfold-content dropdown-menu w-100 border-0 rounded-0 px-3 mt-0 right-0 left-0 mt-n2">
                                            <form id="search_form" action="search" method="GET" class="input-group input-group-sm input-group-merge">
                                                <div class="input-group-append">
                                                    <button type="submit" class="btn">
                                                        <i class="fas fa-search" ></i>
                                                    </button>
                                                </div>
                                                <input type="text" id="search_input" class="form-control search-form-control rounded-pill">
                                            </form>
                                        </div>
                                    </div>
                                    <!-- End Search -->
