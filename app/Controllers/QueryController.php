...
class QueryController {
	...
	function prepareAndExecuteQuery($mysqli_db_connection, $sql_statement, $bind_number, $param_string, $column_values_array){
	...
	function getQueryResults($stmt, $fetch_columns_array, $return_values_bind_number, $return_array){
		if($return_array == 1){
